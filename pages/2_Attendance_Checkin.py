"""Public page: selfie-based attendance check-in/check-out via face recognition."""
...
st.set_page_config(page_title="Attendance Check-in", page_icon="📸")
apply_theme()

page_header("📸", "Attendance Check-in", "First scan of the day checks you in, a later one checks you out.")
